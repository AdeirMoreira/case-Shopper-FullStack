...
describe("Teste ponta a ponta da API", () => {
  ...
  describe("Test entity Purchase", () => {
    ...
    it("test Purchase registration endpoint failed because of missing producsPurchased", async () => {
      ...
      expect(body).toMatchObject({
        message:
          "productsPurchased deve ser um array de produtos e productsPurchased é requerido",
      });
    });

    it("test Purchase registration endpoint failed bacause of inválid productsPurchased", async () => {
    ...
    it("test Purchase registration endpoint failed bacause of id of product purchased is inválid", async () => {
      const failPurchased = {
        ...purchase,
    ...
    it("test Purchase registration endpoint failed bacause of quantity of product purchased is inválid", async () => {
      const failPurchased = {
        ...purchase,
        productsPurchased: [
          {
    ...
    it("test Purchase registration endpoint failed bacause of product purchased not existis in database", async () => {
      ...
      expect(error).toBeTruthy();
      expect(body).toMatchObject({
        message: "Produto de asdfasdfasdfasdfasd não foi encontrado no banco de dados",
      });
    });
    ...
    it("test Purchase registration endpoint failed bacause of deliveryDate is inválid", async () => {
  ...
  describe("Test entity Stock", () => {
    ...
    it("test endpoint update fail bacause miss productsPurchased property", async () => {
      ...
      expect(body).toMatchObject({
        message:
          "productsPurchased deve ser um array de objetos e productsPurchased é requerido",
      });
    });
    ...
    it("test endpoint update fail bacause one product purchased not exists in database", async () => {
      ...
      expect(error).toBeTruthy();
      expect(body).toMatchObject({
        message: `Produto de asdnjlaksdflkasdm não foi encontrado no banco de dados`,
      });
    });
